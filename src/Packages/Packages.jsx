    ...
    return (
        <div className="packages-container">
            ...
            <div className="packages-grid">
                <Card title="Silver Package: £25" className="package-card">
                    <p>
                    ...
                    <Button label="Book Now" className="p-button-outlined p-button-info" onClick={() => onBook('silver')} />
                </Card>

                <Card title="Gold Package: £85" className="package-card">
                    ...
                    <Button label="Book Now" className="p-button-outlined p-button-warning" onClick={() => onBook('gold')} />
                </Card>

                <Card title="Platinum Package: Starting from £165" className="package-card">
                    ...
                    <Button label="Book Now" className="p-button-outlined p-button-success" onClick={() => onBook('platinum')} />
                </Card>
            </div>
